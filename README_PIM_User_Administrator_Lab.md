...
## 🔹 Phase 1 – Admin Configuration (PIM Setup)

### Step 1 – Access Azure Portal
- Sign in to the Azure portal using administrator credentials



---

### Step 2 – Navigate to All Services
- Click **All Services**  
...
---
## 🔐 Phase 2 – Role Activation (User Perspective)

---

### Step 14 – Sign in as User
...
### Step 16 – View Eligible Roles
- Under **Eligible assignments**, locate:  
  - **User Administrator**  

---

### Step 17 – Activate Role
- Click **Activate** 
...
### Step 18 – MFA Triggered (PIM Enforcement)
- A prompt appears: **“Additional verification required”**  
- Click to begin verification  

![pim15](https://github.com/user-attachments/assets/520d5852-f76c-4018-8441-c36f4acdddf0)

👉 MFA is enforced **during role activation**, not at initial login  

---

### Step 19 – Configure Microsoft Authenticator
...
### Step 20 – Provide Activation Details
- Set **Duration** (default: 8 hours)  
- Enter a **reason** (e.g., User creation)  
